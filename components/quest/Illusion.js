    ...
    return (
        <>
            ...
            <ol>
                ...
                <li>Head to the pub, <b>Cat on Bullet</b> <span className="naviText" onClick={(e) => copyNavi(e)} data-map="einbroch" data-x="302" data-y="330">(einbroch 302, 330)</span><span className="naviCopied d-none">Copied!</span>, in Einbroch.</li>
...
<ul><li>10 Dolors.</li>
        ...
        <ol><li>Move up a little and speak with <b>Aas</b>. You'll be warped to the main hall room.</li>
            ...
            <ol>
                ...
                <li>Go near the Rekenber's Headquarters at <span className="naviText" onClick={(e) => copyNavi(e)} data-map="lighthalzen" data-x="108" data-y="163">(lighthalzen 108, 163)</span><span className="naviCopied d-none">Copied!</span> and speak with <b>Rage</b>.
                <ImagePreview src="illusion/n40.png" width="400" height="233"/></li>
                <li>Go inside the Headquarters up north <span className="naviText" onClick={(e) => copyNavi(e)} data-map="lighthalzen" data-x="101" data-y="248">(lighthalzen 101, 248)</span><span className="naviCopied d-none">Copied!</span>. Speak with the <b>Employee</b> member after you enter.
                ...
                <li>Go to Regenschirm, the building left of the Headquarters <span className="naviText" onClick={(e) => copyNavi(e)} data-map="lighthalzen" data-x="53" data-y="278">(lighthalzen 53, 278)</span><span className="naviCopied d-none">Copied!</span>.</li>
            ...
            <ol>
                ...
                <li>Go back to Clana Nemieri, in Einbech <span className="naviText" onClick={(e) => copyNavi(e)} data-map="einbech" data-x="215" data-y="84">(einbech 215, 84)</span><span className="naviCopied d-none">Copied!</span>, then speak with the <b>Rebellion Member</b> inside at <span className="naviText" onClick={(e) => copyNavi(e)} data-map="rebel_in" data-x="68" data-y="41">(rebel_in 68, 41)</span><span className="naviCopied d-none">Copied!</span>.</li>
                ...
                <li>Go back to OS and talk with <b>Dien</b> <span className="naviText" onClick={(e) => copyNavi(e)} data-map="ein_fild03" data-x="288" data-y="270">(ein_fild03 288, 270)</span><span className="naviCopied d-none">Copied!</span>&gt; then enter the portal &gt; <span className="naviText" onClick={(e) => copyNavi(e)} data-map="sp_os" data-x="253" data-y="359">(sp_os 253, 359)</span><span className="naviCopied d-none">Copied!</span>). Hand over the picture and you'll be rewarded with some experience.<br /><i>You now have access to the Cor area.</i><br /><i>You have unlocked the <a href="/wiki/Illusion#Mercenary_vs_Mercenary" title="Illusion">Mercenary vs Mercenary</a> daily quest.</i><br /><i>You have unlocked the <a href="/wiki/Illusion#OS_Mission" title="Illusion">OS Mission</a> quest.</i></li>
