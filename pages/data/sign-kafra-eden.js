          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-8 col-md-10 mx-auto">
                ...
                <a href="#">
                  <img className="img-fluid mx-auto d-block rounded" src={process.env.BACKEND_URL + '/images/sign_kafra&eden.png'} alt="" />
                </a>
                <span className="caption text-muted">Kafra & Eden.</span>

                <p>ป้ายบอก Npc Kafra กับ Eden เพิ่มความสะดวกเวลาคนเยอะในแมพ</p>

                <p>Download : <a href="https://mega.nz/file/YYx11CDK#X5vgKTXHZ3XThT_jEQQsmxss-T6a81Pv1EQZZgH3Q3E" target="_blank">Mega</a></p>
